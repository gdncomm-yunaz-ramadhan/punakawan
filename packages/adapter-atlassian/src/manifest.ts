...
export const manifest: AdapterManifest = {
  ...
  operations: {
    ...
    'atlassian.downloadJiraAttachment': { side_effect: true, approval: 'required' },
    'atlassian.uploadJiraAttachment': { side_effect: true, approval: 'required' },
    'atlassian.deleteJiraAttachment': { side_effect: true, approval: 'required' },
