...
export interface RoleConfig {
  ...
  /**
   * Action ceiling. assist: read/search/analyze/report only, no durable state changes. propose: may create reviewable proposals, nothing applied automatically. execute: may perform enabled capabilities, still under policy/workflow/approval.
   */
